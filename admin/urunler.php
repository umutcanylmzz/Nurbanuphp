...
while ($sonuc = $sorgu->fetch()) {
        ...
        @unlink('../img/' . $sonuc["urunResim1"]);//eski dosya siliniyor. isteğe bağlı
                        ...
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            ...
                            <?php while ($sonuc = $sorgu->fetch()) { ?>
                                ...
                                <tr>
                                    ...
                                    <td><img src="../img/<?= $sonuc["urunResim1"] ?>" width="120px" height="120px"/></td>

                                    <td contenteditable="true"

                                        onBlur="veriKaydet(this,'ustBaslik','<?= $sonuc["id"] ?>')"

                                        onClick="duzenle(this);"><?= $sonuc["urunAciklama"] ?></td>

                                    <td contenteditable="true" onBlur="veriKaydet(this,'baslik','<?= $sonuc["id"] ?>')"

                                        onClick="duzenle(this);"><?= $sonuc["urunFiyat"] ?></td>
                                        ...
                                        <div class="modal fade" id="icerik<?= $sonuc["id"] ?>" tabindex="-1"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body"><?= $sonuc["urunKategori"] ?></div>
